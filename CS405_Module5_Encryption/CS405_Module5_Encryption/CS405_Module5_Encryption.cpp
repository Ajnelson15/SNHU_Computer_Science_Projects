...
void save_data_file(const std::string& filename, const std::string& student_name, const std::string& key, const std::string& data)
{
    ...
    if (file.is_open()) {
        ...
        // Buffer for formatted date (yyyy-mm-dd)
        char date_buffer[11];
...
int main()
{
    ...
    std::cout << "Read File: " << file_name << " - Encrypted To: " << encrypted_file_name << " - Decrypted To: " << decrypted_file_name << "\n" << std::endl;

    // Debug Print
    std::cout << "DEBUG PRINT:" << std::endl;
    std::cout << "Student Name: " << student_name << std::endl;
    std::cout << "Encryption Key: " << key << std::endl;
    std::cout << "Encrypted Preview: " << encrypted_string.substr(0, 20) << "..." << std::endl;
    std::cout << "Decrypted Preview: " << decrypted_string.substr(0, 20) << "..." << std::endl;
}
